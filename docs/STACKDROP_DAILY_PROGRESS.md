...
- 2026-07-21: Committed the 2.4 Rust discovery and watcher consumer migration on `main` as `557b2e5` with message `feat: migrate discovery and watcher capabilities`. Push evidence will be recorded after the normal non-force push completes. No merge, release, or deployment was required for this bounded registry consumer migration.
