...
- 2026-07-17: Committed the 2.1 capability registry design on `main` as `25424f3` with message `docs: design file capability registry`. The commit included only `docs/CAPABILITY_REGISTRY_DESIGN.md`, `docs/stackdrop-architecture.md`, and `docs/STACKDROP_DAILY_PROGRESS.md`; unrelated modified screenshots and Tauri files remained unstaged. Push was pending when this progress entry was written.
